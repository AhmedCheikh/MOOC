...
class appProdDebugProjectContainer extends Container
{
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_0000000057c87af7000000005dc0e724ce34c9aad975ae8779e0c6a17040edab(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_0000000057c87af2000000005dc0e724ce34c9aad975ae8779e0c6a17040edab(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
...
class VichUploaderBundleHandlerDownloadHandler_0000000057c87af7000000005dc0e724ce34c9aad975ae8779e0c6a17040edab extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5712256d9f9ed417114440 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5712256d9fa0b382562530 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5712256d9f9aa169098032 = array(
    ...
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer5712256d9fa0b382562530);

        return $this->valueHolder5712256d9f9ed417114440->downloadObject($object, $field, $className, $fileName);
    }
    ...
    {
        $this->initializer5712256d9fa0b382562530 = $initializer;
    }
    ...
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, '__get', array('name' => $name), $this->initializer5712256d9fa0b382562530);

        if (isset(self::$publicProperties5712256d9f9aa169098032[$name])) {
            return $this->valueHolder5712256d9f9ed417114440->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5712256d9f9ed417114440;
    ...
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5712256d9fa0b382562530);
    ...
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, '__isset', array('name' => $name), $this->initializer5712256d9fa0b382562530);
    ...
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, '__unset', array('name' => $name), $this->initializer5712256d9fa0b382562530);
    ...
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, '__clone', array(), $this->initializer5712256d9fa0b382562530);

        $this->valueHolder5712256d9f9ed417114440 = clone $this->valueHolder5712256d9f9ed417114440;
    }

    public function __sleep()
    {
        $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, '__sleep', array(), $this->initializer5712256d9fa0b382562530);

        return array('valueHolder5712256d9f9ed417114440');
    }
    ...
    {
        return $this->initializer5712256d9fa0b382562530;
    }
    ...
    {
        return $this->initializer5712256d9fa0b382562530 && $this->initializer5712256d9fa0b382562530->__invoke($this->valueHolder5712256d9f9ed417114440, $this, 'initializeProxy', array(), $this->initializer5712256d9fa0b382562530);
    }
    ...
    {
        return null !== $this->valueHolder5712256d9f9ed417114440;
    }
    ...
    {
        return $this->valueHolder5712256d9f9ed417114440;
    }


}

class VichUploaderBundleHandlerUploadHandler_0000000057c87af2000000005dc0e724ce34c9aad975ae8779e0c6a17040edab extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5712256da084c740314881 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5712256da0864508251987 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5712256da0824568724720 = array(
    ...
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5712256da0864508251987);

        return $this->valueHolder5712256da084c740314881->upload($obj, $fieldName);
    }
    ...
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5712256da0864508251987);

        return $this->valueHolder5712256da084c740314881->inject($obj, $fieldName);
    }
    ...
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5712256da0864508251987);

        return $this->valueHolder5712256da084c740314881->clean($obj, $fieldName);
    }
    ...
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5712256da0864508251987);

        return $this->valueHolder5712256da084c740314881->remove($obj, $fieldName);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer5712256da0864508251987 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, '__get', array('name' => $name), $this->initializer5712256da0864508251987);

        if (isset(self::$publicProperties5712256da0824568724720[$name])) {
            return $this->valueHolder5712256da084c740314881->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5712256da084c740314881;
    ...
    public function __set($name, $value)
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5712256da0864508251987);
    ...
    public function __isset($name)
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, '__isset', array('name' => $name), $this->initializer5712256da0864508251987);
    ...
    public function __unset($name)
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, '__unset', array('name' => $name), $this->initializer5712256da0864508251987);
    ...
    public function __clone()
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, '__clone', array(), $this->initializer5712256da0864508251987);

        $this->valueHolder5712256da084c740314881 = clone $this->valueHolder5712256da084c740314881;
    }

    public function __sleep()
    {
        $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, '__sleep', array(), $this->initializer5712256da0864508251987);

        return array('valueHolder5712256da084c740314881');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5712256da0864508251987;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer5712256da0864508251987 && $this->initializer5712256da0864508251987->__invoke($this->valueHolder5712256da084c740314881, $this, 'initializeProxy', array(), $this->initializer5712256da0864508251987);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5712256da084c740314881;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5712256da084c740314881;
    }
