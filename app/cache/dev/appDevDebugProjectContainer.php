...
'), 'default_entity_name' => 'Formateur', 'default_menu_item' => NULL, 'homepage' => array('route' => 'easyadmin', 'params' => array('action' => 'list', 'entity' => 'Formateur'))), $this->get('property_accessor'));
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_0000000076ff43750000000000fe6c5c3c6b334300e435587111272351cb6f0c(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_0000000076ff436f0000000000fe6c5c3c6b334300e435587111272351cb6f0c(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
...
class VichUploaderBundleHandlerDownloadHandler_0000000076ff43750000000000fe6c5c3c6b334300e435587111272351cb6f0c extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder573850fb8fc32173987013 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer573850fb8fc7c505610968 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties573850fb8fbaa140554906 = array(
    ...
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer573850fb8fc7c505610968);

        return $this->valueHolder573850fb8fc32173987013->downloadObject($object, $field, $className, $fileName);
    }
    ...
    {
        $this->initializer573850fb8fc7c505610968 = $initializer;
    }
    ...
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, '__get', array('name' => $name), $this->initializer573850fb8fc7c505610968);

        if (isset(self::$publicProperties573850fb8fbaa140554906[$name])) {
            return $this->valueHolder573850fb8fc32173987013->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder573850fb8fc32173987013;
    ...
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer573850fb8fc7c505610968);
    ...
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, '__isset', array('name' => $name), $this->initializer573850fb8fc7c505610968);
    ...
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, '__unset', array('name' => $name), $this->initializer573850fb8fc7c505610968);
    ...
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, '__clone', array(), $this->initializer573850fb8fc7c505610968);

        $this->valueHolder573850fb8fc32173987013 = clone $this->valueHolder573850fb8fc32173987013;
    }

    public function __sleep()
    {
        $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, '__sleep', array(), $this->initializer573850fb8fc7c505610968);

        return array('valueHolder573850fb8fc32173987013');
    }
    ...
    {
        return $this->initializer573850fb8fc7c505610968;
    }
    ...
    {
        return $this->initializer573850fb8fc7c505610968 && $this->initializer573850fb8fc7c505610968->__invoke($this->valueHolder573850fb8fc32173987013, $this, 'initializeProxy', array(), $this->initializer573850fb8fc7c505610968);
    }
    ...
    {
        return null !== $this->valueHolder573850fb8fc32173987013;
    }
    ...
    {
        return $this->valueHolder573850fb8fc32173987013;
    }


}

class VichUploaderBundleHandlerUploadHandler_0000000076ff436f0000000000fe6c5c3c6b334300e435587111272351cb6f0c extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder573850fb927c0718066558 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer573850fb9281a786906619 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties573850fb92742405093683 = array(
    ...
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer573850fb9281a786906619);

        return $this->valueHolder573850fb927c0718066558->upload($obj, $fieldName);
    }
    ...
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer573850fb9281a786906619);

        return $this->valueHolder573850fb927c0718066558->inject($obj, $fieldName);
    }
    ...
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer573850fb9281a786906619);

        return $this->valueHolder573850fb927c0718066558->clean($obj, $fieldName);
    }
    ...
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer573850fb9281a786906619);

        return $this->valueHolder573850fb927c0718066558->remove($obj, $fieldName);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer573850fb9281a786906619 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, '__get', array('name' => $name), $this->initializer573850fb9281a786906619);

        if (isset(self::$publicProperties573850fb92742405093683[$name])) {
            return $this->valueHolder573850fb927c0718066558->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder573850fb927c0718066558;
    ...
    public function __set($name, $value)
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer573850fb9281a786906619);
    ...
    public function __isset($name)
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, '__isset', array('name' => $name), $this->initializer573850fb9281a786906619);
    ...
    public function __unset($name)
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, '__unset', array('name' => $name), $this->initializer573850fb9281a786906619);
    ...
    public function __clone()
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, '__clone', array(), $this->initializer573850fb9281a786906619);

        $this->valueHolder573850fb927c0718066558 = clone $this->valueHolder573850fb927c0718066558;
    }

    public function __sleep()
    {
        $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, '__sleep', array(), $this->initializer573850fb9281a786906619);

        return array('valueHolder573850fb927c0718066558');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer573850fb9281a786906619;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer573850fb9281a786906619 && $this->initializer573850fb9281a786906619->__invoke($this->valueHolder573850fb927c0718066558, $this, 'initializeProxy', array(), $this->initializer573850fb9281a786906619);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder573850fb927c0718066558;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder573850fb927c0718066558;
    }
