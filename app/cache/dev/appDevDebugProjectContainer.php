...
class appDevDebugProjectContainer extends Container
{
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_0000000026817a64000000007939e074e5d7e14eba4acd3b4a4595b7b8aa674d(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_0000000026817a7f000000007939e074e5d7e14eba4acd3b4a4595b7b8aa674d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
...
class VichUploaderBundleHandlerDownloadHandler_0000000026817a64000000007939e074e5d7e14eba4acd3b4a4595b7b8aa674d extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder571225613b5ee618492680 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer571225613b60c174834009 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties571225613b5ac421255954 = array(
    ...
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer571225613b60c174834009);

        return $this->valueHolder571225613b5ee618492680->downloadObject($object, $field, $className, $fileName);
    }
    ...
    {
        $this->initializer571225613b60c174834009 = $initializer;
    }
    ...
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, '__get', array('name' => $name), $this->initializer571225613b60c174834009);

        if (isset(self::$publicProperties571225613b5ac421255954[$name])) {
            return $this->valueHolder571225613b5ee618492680->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder571225613b5ee618492680;
    ...
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer571225613b60c174834009);
    ...
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, '__isset', array('name' => $name), $this->initializer571225613b60c174834009);
    ...
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, '__unset', array('name' => $name), $this->initializer571225613b60c174834009);
    ...
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, '__clone', array(), $this->initializer571225613b60c174834009);

        $this->valueHolder571225613b5ee618492680 = clone $this->valueHolder571225613b5ee618492680;
    }

    public function __sleep()
    {
        $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, '__sleep', array(), $this->initializer571225613b60c174834009);

        return array('valueHolder571225613b5ee618492680');
    }
    ...
    {
        return $this->initializer571225613b60c174834009;
    }
    ...
    {
        return $this->initializer571225613b60c174834009 && $this->initializer571225613b60c174834009->__invoke($this->valueHolder571225613b5ee618492680, $this, 'initializeProxy', array(), $this->initializer571225613b60c174834009);
    }
    ...
    {
        return null !== $this->valueHolder571225613b5ee618492680;
    }
    ...
    {
        return $this->valueHolder571225613b5ee618492680;
    }


}

class VichUploaderBundleHandlerUploadHandler_0000000026817a7f000000007939e074e5d7e14eba4acd3b4a4595b7b8aa674d extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder571225613c4e5512957092 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer571225613c4fe374610515 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties571225613c4b5215396300 = array(
    ...
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer571225613c4fe374610515);

        return $this->valueHolder571225613c4e5512957092->upload($obj, $fieldName);
    }
    ...
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer571225613c4fe374610515);

        return $this->valueHolder571225613c4e5512957092->inject($obj, $fieldName);
    }
    ...
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer571225613c4fe374610515);

        return $this->valueHolder571225613c4e5512957092->clean($obj, $fieldName);
    }
    ...
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer571225613c4fe374610515);

        return $this->valueHolder571225613c4e5512957092->remove($obj, $fieldName);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer571225613c4fe374610515 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, '__get', array('name' => $name), $this->initializer571225613c4fe374610515);

        if (isset(self::$publicProperties571225613c4b5215396300[$name])) {
            return $this->valueHolder571225613c4e5512957092->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder571225613c4e5512957092;
    ...
    public function __set($name, $value)
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer571225613c4fe374610515);
    ...
    public function __isset($name)
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, '__isset', array('name' => $name), $this->initializer571225613c4fe374610515);
    ...
    public function __unset($name)
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, '__unset', array('name' => $name), $this->initializer571225613c4fe374610515);
    ...
    public function __clone()
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, '__clone', array(), $this->initializer571225613c4fe374610515);

        $this->valueHolder571225613c4e5512957092 = clone $this->valueHolder571225613c4e5512957092;
    }

    public function __sleep()
    {
        $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, '__sleep', array(), $this->initializer571225613c4fe374610515);

        return array('valueHolder571225613c4e5512957092');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer571225613c4fe374610515;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer571225613c4fe374610515 && $this->initializer571225613c4fe374610515->__invoke($this->valueHolder571225613c4e5512957092, $this, 'initializeProxy', array(), $this->initializer571225613c4fe374610515);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder571225613c4e5512957092;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder571225613c4e5512957092;
    }
