...
<html lang=\"en\">
    <head>
        ...
        <title>Passer quiz finale</title>
    ...
    <body onload=\"startTime()\">
        ...
        // line 416
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("mooc_mooc_passer_quiz", array("id" => $this->getAttribute((isset($context["quiz"]) ? $context["quiz"] : $this->getContext($context, "quiz")), "id", array()))), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  563 => 456,  558 => 454,  554 => 453,  549 => 451,  545 => 450,  523 => 430,  517 => 429,  503 => 425,  499 => 423,  495 => 422,  490 => 420,  483 => 418,  478 => 416,  471 => 412,  452 => 396,  363 => 310,  343 => 293,  274 => 227,  259 => 215,  244 => 203,  229 => 191,  58 => 23,  54 => 22,  49 => 20,  45 => 19,  39 => 16,  34 => 14,  19 => 1,);
    }
}
/* <!DOCTYPE html>*/
/* <html lang="en">*/
...
/*                                 <div class="panel-body">*/
/*                                     <div class="form">*/
/*                                         <form name="f1" class="form-validate form-horizontal" id="feedback_form" method="POST" action="{{path ('mooc_mooc_passer_quiz',{'id':quiz.id})}}">*/
/* */
/*                                            {% for q in rep %} */
/* */
