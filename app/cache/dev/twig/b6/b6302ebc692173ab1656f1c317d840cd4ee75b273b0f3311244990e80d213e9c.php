...
class __TwigTemplate_978965d5c39bcc9db2f4b0aec750eec2293c3dcf6365a7c566aeaa0778c311ab extends Twig_Template
{
...
";
    ...
    public function block_user_menu($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array())) {
            ...
            echo " | <a href=\"";
            echo $this->env->getExtension('routing')->getPath("mooc_mooc_log_out_comite");
            echo "\"> Logout </a></span>                                  
                                        ";
        }
        // line 80
...
/*                                     {% else %}*/
/*                                         <span>  {{ 'Espace comité pédagogique'|trans(domain = 'EasyAdminBundle') }} | <a href="{{path('mooc_mooc_log_out_comite')}}"> Logout </a></span>                                  */
/*                                         {% endif %}*/
/*                                 {% endblock user_menu %}*/
/*                             </li>*/
/*                         </ul>*/
