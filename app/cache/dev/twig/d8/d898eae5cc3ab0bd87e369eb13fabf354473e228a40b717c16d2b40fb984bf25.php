...
/* MoocMoocBundle:Organisme:loginOrganisme.html.twig */
class __TwigTemplate_24d42c0ca6d0eee3c567880df2c055a38368ff36d116a9f2259612fffc25b4fb extends Twig_Template
{
  ...
  <body class=\"login-img3-body\">
    ...
    <div class=\"container\">
      ...
      <form class=\"login-form\" action=\"";
        ...
        echo $this->env->getExtension('routing')->getPath("mooc_mooc_PassOublier");
        echo "\">Mot de passe oublier </a>- <a href=\"";
        echo $this->env->getExtension('routing')->getPath("mooc_mooc_PreinscriptionOrganisme");
...
";
    ...
    {
        return "MoocMoocBundle:Organisme:loginOrganisme.html.twig";
    }
...
/*     <div class="container">*/
/* */
/*       <form class="login-form" action="{{path('mooc_mooc_logOrganisme')}}" method="post" data-validate="parsley">        */
/*         <div class="login-wrap">*/
/*             <p class="login-img"><i class="icon_lock_alt"></i></p>*/
/*             {#message d'errer#}*/
/*                     {% if name is defined %}*/
...
/*             <center><a href="{{path('mooc_mooc_homepage')}}">Page d'acceuil </a> --<a href="{{path('mooc_mooc_PassOublier')}}">Mot de passe oublier </a>- <a href="{{path('mooc_mooc_PreinscriptionOrganisme')}}">Pas encore Inscrit </a></center>*/
/*         </div>*/
/*       </form>*/
/* */
/*     </div>*/
