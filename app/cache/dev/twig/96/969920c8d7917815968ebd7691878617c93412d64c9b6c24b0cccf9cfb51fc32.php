...
<html lang=\"en\">
    ...
    <body>
        ...
        // line 371
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("mooc_mooc_modifier_qz", array("id" => (isset($context["idquiz"]) ? $context["idquiz"] : $this->getContext($context, "idquiz")), "type" => (isset($context["type"]) ? $context["type"] : $this->getContext($context, "type")))), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  506 => 420,  501 => 418,  497 => 417,  492 => 415,  488 => 414,  466 => 395,  458 => 389,  453 => 387,  451 => 386,  447 => 384,  445 => 383,  434 => 375,  427 => 371,  328 => 275,  308 => 258,  239 => 192,  224 => 180,  209 => 168,  194 => 156,  58 => 23,  54 => 22,  49 => 20,  45 => 19,  39 => 16,  34 => 14,  19 => 1,);
    }
}
/* <!DOCTYPE html>*/
/* <html lang="en">*/
...
/*                                 <div class="panel-body">*/
/*                                     <div class="form">*/
/*                                         <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="{{path ('mooc_mooc_modifier_qz',{'id':idquiz,'type':type})}}">*/
/*                                             <div class="form-group ">*/
/*                                                 <label for="cname" class="control-label col-lg-2">Nom quiz <span class="required">*</span></label>*/
/*                                                 <div class="col-lg-10">*/
