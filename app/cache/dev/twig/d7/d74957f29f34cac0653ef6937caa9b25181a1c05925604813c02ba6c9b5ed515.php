...
<html lang=\"en\">
    ...
    <body>
        ...
        // line 375
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("mooc_mooc_Modifier_chapitre", array("id" => (isset($context["idchapitre"]) ? $context["idchapitre"] : $this->getContext($context, "idchapitre")), "idcours" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  550 => 444,  546 => 443,  541 => 441,  537 => 440,  533 => 439,  529 => 438,  525 => 437,  521 => 436,  492 => 409,  481 => 407,  477 => 406,  471 => 403,  450 => 385,  441 => 379,  434 => 375,  411 => 355,  328 => 275,  308 => 258,  239 => 192,  224 => 180,  209 => 168,  194 => 156,  58 => 23,  54 => 22,  49 => 20,  45 => 19,  39 => 16,  34 => 14,  19 => 1,);
    }
}
/* <!DOCTYPE html>*/
/* <html lang="en">*/
...
/*                                 <div class="panel-body">*/
/*                                     <div class="form">*/
/*                                         <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="{{path('mooc_mooc_Modifier_chapitre',{'id':idchapitre,'idcours':id})}}">*/
/*                                             <div class="form-group ">*/
/*                                                 <label for="cname" class="control-label col-lg-2">Nom chapitre <span class="required">*</span></label>*/
/*                                                 <div class="col-lg-10">*/
