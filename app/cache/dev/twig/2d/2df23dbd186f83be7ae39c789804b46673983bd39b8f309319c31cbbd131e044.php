...
/* MoocMoocBundle:Comite:logincomite.html.twig */
class __TwigTemplate_301439a94c102ce5927af29d8322be3db30c09791c14b48afef429c599c5965b extends Twig_Template
{
...
";
    ...
    {
        return "MoocMoocBundle:Comite:logincomite.html.twig";
    }
...
/*     <div class="container">*/
/* */
/*       <form class="login-form" action="{{path('mooc_mooc_logcomite')}}" method="post" data-validate="parsley">        */
/*         <div class="login-wrap">*/
/*             <p class="login-img"><i class="icon_lock_alt"></i></p>*/
/*             {#message d'errer#}*/
/*                     {% if nom is defined %}*/
